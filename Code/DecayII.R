...
for (i in 2:100){
  ...
  write.table(data_sim,"Data/data_DecayII.txt", sep = "," ,quote = FALSE,row.names = FALSE)
  
  # Fit viral decay model using Monolix.
  start.time <- Sys.time()
  data = list(dataFile = paste0('Data/data_DecayII.txt'),
...
write.csv(estimates_SAEM, "Results/DecayII/estimates_SAEM.csv", row.names = FALSE)
write.csv(estimates_NLME, "Results/DecayII/estimates_NLME.csv", row.names = FALSE)
write.csv(estimates_LME4, "Results/DecayII/estimates_LME4.csv", row.names = FALSE)
write.csv(SE_SAEM, "Results/DecayII/SE_SAEM.csv", row.names = FALSE)
write.csv(SE_NLME, "Results/DecayII/SE_NLME.csv", row.names = FALSE)
write.csv(SE_LME4, "Results/DecayII/SE_LME4.csv", row.names = FALSE)
write.csv(time_SAEM, "Results/DecayII/time_SAEM.csv", row.names = FALSE)
write.csv(time_NLME, "Results/DecayII/time_NLME.csv", row.names = FALSE)
write.csv(time_LME4, "Results/DecayII/time_LME4.csv", row.names = FALSE)


#======================Calculate MSE and bias===================
# Read the results file
estimates_SAEM <- read.csv("Results/DecayII/estimates_SAEM.csv")
estimates_NLME <- read.csv("Results/DecayII/estimates_NLME.csv")
estimates_LME4 <- read.csv("Results/DecayII/estimates_LME4.csv")
SE_SAEM <- read.csv("Results/DecayII/SE_SAEM.csv")
SE_NLME <- read.csv("Results/DecayII/SE_NLME.csv")
SE_LME4 <- read.csv("Results/DecayII/SE_LME4.csv")
time_SAEM <- read.csv("Results/DecayII/time_SAEM.csv")
time_NLME <- read.csv("Results/DecayII/time_NLME.csv")
time_LME4 <- read.csv("Results/DecayII/time_LME4.csv")
...
print(latex_table, file = "Table/DecayII.tex",include.rownames=FALSE,sanitize.text.function = function(x){x},hline.after = c(-1,0,9))
