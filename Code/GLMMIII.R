...
for (i in 1:num_sim){
  ...
  write.table(data_sim,"Data/data_GLMMIII.txt", sep = "," ,quote = FALSE,row.names = FALSE)
  
  # Fit viral decay model using Monolix.
  start.time <- Sys.time()
  data = list(dataFile = paste0('Data/data_GLMMIII.txt'),
  ...
  write.csv(estimates_SAEM, "Results/GLMMIII/estimates_SAEM.csv", row.names = FALSE)
  write.csv(estimates_LME4, "Results/GLMMIII/estimates_LME4.csv", row.names = FALSE)
  write.csv(SE_SAEM, "Results/GLMMIII/SE_SAEM.csv", row.names = FALSE)
  write.csv(SE_LME4, "Results/GLMMIII/SE_LME4.csv", row.names = FALSE)
  write.csv(time_SAEM, "Results/GLMMIII/time_SAEM.csv", row.names = FALSE)
  write.csv(time_LME4, "Results/GLMMIII/time_LME4.csv", row.names = FALSE)
}  
...
estimates_SAEM <- read.csv("Results/GLMMIII/estimates_SAEM.csv")
estimates_LME4 <- read.csv("Results/GLMMIII/estimates_LME4.csv")
SE_SAEM <- read.csv("Results/GLMMIII/SE_SAEM.csv")
SE_LME4 <- read.csv("Results/GLMMIII/SE_LME4.csv")
time_SAEM <- read.csv("Results/GLMMIII/time_SAEM.csv")
time_LME4 <- read.csv("Results/GLMMIII/time_LME4.csv")
...
print(latex_table, file = "Table/GLMMIII.tex",include.rownames=FALSE,sanitize.text.function = function(x){x},hline.after = c(-1,0,4))
